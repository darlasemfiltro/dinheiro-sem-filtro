...
export const AiTipsView: React.FC<AiTipsViewProps> = ({
  ...
  const generateClientPortfolioAnalysis = (): AIPortfolioAdvice => {
    ...
    return {
      ...
      warningPoints,
      studyTips,
      disclaimer: "Aviso importante: Esta análise e as dicas fornecidas possuem caráter estritamente educacional e informativo, e não constituem recomendação de investimento ou indicação de compra e venda de ativos de acordo com o mercado.",
  ...
  return (
    <div className="space-y-6 pb-12">
      ...
      <div className="p-6 bg-gradient-to-r from-[#121212] via-[#18181B] to-[#121212] border-2 border-[#D4AF37] rounded-3xl shadow-2xl flex flex-col md:flex-row items-start md:items-center justify-between gap-4">
        ...
        {/* Submenu Pill Nav */}
        <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 bg-[#18181B] p-2 border border-[#D4AF37]/50 rounded-2xl w-full sm:w-auto shadow-inner">
          <button
            onClick={() => handleSubTabChange('orcamento')}
            className={`w-full sm:w-auto px-4 py-3 sm:py-2.5 rounded-xl font-black text-xs transition flex items-center justify-center gap-2 cursor-pointer whitespace-nowrap ${
              subTab === 'orcamento'
        ...
        <div className="space-y-6 animate-in fade-in">
          ...
          {isGeneratingPortfolio ? (
            ...
            <div className="space-y-4">
              ...
              <div className="p-5 bg-[#14120C] border-2 border-amber-500/50 rounded-2xl shadow-xl">
                <p className="text-xs sm:text-sm text-amber-200/90 leading-relaxed font-medium flex items-start gap-2">
                  <span className="shrink-0 mt-0.5">⚠️</span>
                  <span>{portfolioAdvice.disclaimer || "Aviso importante: Esta análise e as dicas fornecidas possuem caráter estritamente educacional e informativo, e não constituem recomendação de investimento ou indicação de compra e venda de ativos de acordo com o mercado."}</span>
                </p>
              </div>
            </div>
          ) : (
            <div className="p-8 bg-[#18181B] border border-[#D4AF37]/30 rounded-3xl text-center space-y-4 shadow-xl max-w-xl mx-auto">
              ...
              <p className="text-xs text-amber-200/80 font-medium">
                As análises e dicas do aplicativo têm caráter estritamente educativo e informativo, e <strong>não são recomendações de investimento de acordo com o mercado</strong>.
              </p>
              <button
                onClick={fetchPortfolioAnalysis}
