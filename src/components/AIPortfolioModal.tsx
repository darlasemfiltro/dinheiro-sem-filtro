  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-xs animate-in fade-in duration-200">
      <div className="bg-[#121212] text-white border-2 border-[#D4AF37] w-full max-w-3xl rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[92vh]">
        ...
        {/* Disclaimer Bar */}
        <div className="bg-[#1C180A] border-b border-[#D4AF37]/20 px-5 py-2.5 flex items-center gap-2.5 text-[11px] text-amber-200/90 font-medium">
          ...
          {isGenerating ? (
            ...
            <>
              ...
              <div className="space-y-4">
                ...
                <div className="p-4 sm:p-5 bg-[#14120C] border-2 border-amber-500/50 rounded-2xl space-y-2 shadow-xl">
                  <div className="flex items-center gap-2 text-amber-400">
                  ...
                  <p className="text-xs sm:text-sm text-amber-200/90 leading-relaxed font-medium">
                    {advice.disclaimer || "⚠️ Aviso importante: Esta análise e as dicas fornecidas possuem caráter estritamente educacional e informativo. Não constituem recomendação de investimento ou indicação de compra e venda de ativos de acordo com o mercado."}
                  </p>
                </div>
              </div>
            </>
            ...
            <div className="py-12 text-center space-y-4 max-w-md mx-auto">
              ...
              <div className="space-y-1.5">
                ...
                <p className="text-xs text-amber-200/80 leading-relaxed font-medium">
                  ⚠️ Esta análise e as dicas do aplicativo possuem caráter estritamente educativo e informativo, e <strong>não são recomendações de investimento de acordo com o mercado</strong>.
                </p>
              </div>
              <button
                onClick={onRefreshAIAdvice}
