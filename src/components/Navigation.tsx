          ...
          >
            ...
            <div className="p-5 border-b border-[#D4AF37]/30 flex items-center justify-between bg-[#121212] sticky top-0 z-20">
              <div className="flex items-center gap-2">
                <div className="w-8 h-8 rounded-full bg-[#D4AF37] text-[#121212] font-black flex items-center justify-center text-sm shadow-md">
                  D
                </div>
                <div>
                  <h2 className="text-xs font-black text-white tracking-wider font-serif">DINHEIRO SEM FILTRO</h2>
                </div>
              </div>
