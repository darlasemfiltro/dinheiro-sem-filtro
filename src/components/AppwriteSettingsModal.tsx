...
export const AppwriteSettingsModal: React.FC<AppwriteSettingsModalProps> = ({
  ...
  const handleForceUpload = async () => {
    if (!confirm('Deseja enviar todos os lançamentos, contas e categorias deste aparelho para a nuvem Appwrite?')) {
      return;
    }
  ...
  const handleForceDownload = async () => {
    if (!confirm('Deseja baixar os dados salvos na nuvem Appwrite para este aparelho?')) {
      return;
    }
