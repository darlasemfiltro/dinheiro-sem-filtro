          ...
          try {
            ...
            if (remoteData) {
              if (Array.isArray(remoteData.accounts)) {
                StorageService.setAccounts(remoteData.accounts, canonicalId);
              }
              if (Array.isArray(remoteData.categories)) {
                StorageService.setCategories(remoteData.categories, canonicalId);
              }
              if (Array.isArray(remoteData.familyMembers)) {
                StorageService.setFamilyMembers(remoteData.familyMembers, canonicalId);
              }
              if (Array.isArray(remoteData.transactions)) {
                StorageService.setTransactions(remoteData.transactions, canonicalId);
              }
              if (Array.isArray(remoteData.goals)) {
                StorageService.setGoals(remoteData.goals as any, canonicalId);
              }
