...
export const AppProvider: React.FC<{
  ...
  // Build full payload for active budget user
  ...
  // Central Persistence Function with immediate reactive update & Cloud sync
